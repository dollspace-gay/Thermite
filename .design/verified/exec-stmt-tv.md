...
audited-content-sha256: 88eaf4d5bd594b61ca723f28d087667170d371e5a2254fb17620a1cb570f15d6 (re-pinned 2026-08-05 after leafwise final record-result composition over indexed state)
...
- **Heap-backed, enum, or wider alias/call-effect aggregate mutation.** Direct
  ...
  likewise return those overlays leafwise.
  `Vec::push`, `Map::insert`, String mutation, mutable
  enum payloads, index-then-field and array-element-root aliases,
  intermediate/general whole-record by-value materialization after a descendant
  sequence overlay, nested/general mutable-call
