...
pub use lower::{
    ...
    lower_l3_library, lower_l3_library_with_boundaries, spec_fn_param_type_map, u64_bit_defs,
    L3BoundaryBinding, L3Export, L3ExportVisibility, L3LibraryTarget, LowerError,
};
