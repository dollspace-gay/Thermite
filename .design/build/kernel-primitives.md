...
audited-content-sha256: 8803c54ff0e1df9d89179debd4da4bc94644b031b23ddb10f725fb81e4a79592 (re-pinned 2026-08-05 after typed logical-record snapshots over projected indexed state; no kernel policy or implementation was added)
extends:
...
The expanded 88-row fixture executes both the direct returned record and the
independently mutated intermediate snapshot from a downstream consumer at L3.
Static ownership, index-then-field aliasing, array-element-root calls, arbitrary
native aggregate materialization or by-value call/match use after a descendant
sequence overlay, nested or
