...
tier: 3-component
status: shipped
audited-content-sha256: 8a93aa34f5fdfaeac926fa77f4e4198ce870c5899e921c67d643b13e3de110e8 (re-pinned 2026-08-05 after mixed-borrow lifecycle composition and the no_std vstd-prelude assertion repair; named-record semantics remain regression-covered)
...
atomic-object machine refinement, mutable slice/array or projected-root call
effects, and separate Rust/assembly TPL refinement remain
...
`.design/build/mutable-call-effects.md`, including nonoverlapping shared
finite-record snapshots. It also does not add any kernel policy
or kernel artifact.
