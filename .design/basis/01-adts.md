...
| REQ-5 (exhaustiveness checking in the validator) | NOT-STARTED | epic **#62** Stage 1. `validator.rs` has no enum-variant-set collection and no `NonExhaustiveMatch`/`UnreachableArm` `SpecError` variant. |
