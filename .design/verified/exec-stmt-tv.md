...
audited-content-sha256: 0e97c663e5ae9b2cab334623cba36c3b2258b9af4486b6a95329aceac3766bbd (re-pinned 2026-08-05 after leafwise record-formal overlay composition and structural aliasing)
...
- **Heap-backed, enum, or wider alias/call-effect aggregate mutation.** Direct
  ...
  mutable record calls and shared record snapshots without conversion to native arrays.
  `Vec::push`, `Map::insert`, String mutation, mutable
  enum payloads, index-then-field and array-element-root aliases, general whole-record
  value/result materialization after a descendant sequence overlay, nested/general mutable-call
