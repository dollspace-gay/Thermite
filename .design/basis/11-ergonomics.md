...
tier: 3-component
status: draft
audited-sha: 6b86f74476122cfddbdcf168d37a3561d2598054 (re-pinned 2026-06-16 for PR #46 after merging main: governed l1.rs changes are the ADT-aware TString runtime gate plus main's inert Item::Forge skip; ergonomics desugars, match lowering, and loop-control behavior are unchanged.)
