...
pub use lower::{
    ...
    expr_uses_u64_bit_methods, fixed_array_equality_defs, lower, lower_contract_expr,
    lower_equivalence_obligation, lower_exec_body, lower_exec_expr, lower_l3_library,
