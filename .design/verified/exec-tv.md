...
audited-content-sha256: f83b3a7bff3c700d40a3f76e3712212b6a92ca22b00440ea5897e217793e9cac (re-pinned 2026-08-04 after supplying finite plain aggregate relation frames to independent exec TV)
...
- **REQ-1 (exec-expr reference encoder — independent, EXEC semantics)** —
  ...
  plain record/tuple/nested array. Derived
...
arithmetic/cast/comparison/call/index/finite-storage-method subset of `Expr` — NO statements, NO `let`, NO loops, NO
