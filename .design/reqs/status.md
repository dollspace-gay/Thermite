...
| REQ-REG-2 | shipped | `tooling/req-registry.py` | tooling | Accepted status enum | symbol: `VALID_STATUSES` - validator enum<br>test: `tooling/tests/test_req_registry.py::ReqRegistryOracleTest.test_rejects_unknown_status` - oracle for closed enum behavior |  |
...
| REQ-REG-5 | partial | `tooling/req-status.py` | tooling | Legacy source-comment bridge | file: `tooling/req-status.py` - short-term contradiction tripwire<br>command: `python3 tooling/req-status.py` - legacy row lint stays green during migration | Migrate the 429 legacy source-comment rows into stable registry IDs, then replace hand-maintained tables with generated regions or links.<br>blockers: #17 |
| REQ-REG-6 | deferred | `.design/tooling/req-registry.md` | tooling | Generated-region migration | issue: `#17` - RFC tracking the full migration plan | Define generated-region markers and migrate source comments doc-by-doc after stable ID mapping is reviewed.<br>blockers: #17 |
