...
//! and the test skips with a logged note if it is absent (mirroring
...
/// Skips with a logged note if verus is absent.
...
/// semantic equivalence under verus; these pin the independent encoding for
