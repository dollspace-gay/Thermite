...
audited-content-sha256: 4b39f0394b65df8c6827fbac80042468b84b392e4c75974da7258515cb9909db (re-pinned 2026-08-05 after direct scalar logical-record value observers reached strict L3; no kernel policy or implementation was added)
extends:
...
One direct source-derived pure observer may now consume that logical finite
record by value when its other formals and result are scalar/unit: body TV
snapshots the formal leafwise and interprets the exact reachable Thermite body,
while generated code executes the ordinary native-record call. The expanded
105-row fixture executes the returned records and the observer result from a
downstream consumer at L3.
Static ownership, index-then-field aliasing, array-element-root calls, arbitrary
native aggregate materialization, aggregate-returning or nested/general
by-value call use after a descendant sequence overlay, native aggregate
matching, nested or
